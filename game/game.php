...
<div id="objects">
<div id="oMap" style="background-position: 
<?php echo $poz_x; ?>px <?php echo $poz_y; ?>px; background-image: url('<?php echo $mapa['maps']; ?>');"></div>

<div id="status">
<?php echo "".$mapa['nazwa']." (".$player['x'].",".$player['y'].")"; ?></div>
